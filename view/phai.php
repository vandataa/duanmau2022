...
?>
        ...
        <div class="search border-t bg-gray-300 ">
            ...
            <form action="" method="post"><input class="ml-2 w-[220px]" type="text" name="search" id="search"
                    placeholder="Nhập gì đó đi">
                <input type="submit" class="bg-yellow-200 text-brow-200 ml-[70px] mt-[10px] mb-[10px] p-1 rounded hover:bg-red-300 hover:text-white" value="Tìm kiếm">
            </form>
        </div>
